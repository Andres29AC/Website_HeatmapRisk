...
st.set_page_config(page_title="Informacion Moche",page_icon=":information_source:", layout="wide")

st.title(body=":chart_with_upwards_trend: Moche")
...
data = {
    ...
    "Numero de Delitos (year 2023)": [283, 63, 38, 22, 9, 7, 2, 1, 1, 1]
}
...
fig_pie = px.pie(df_pie, values='Numero de Delitos (year 2023)', names='Categoria de Delito',
                 title='Distribucion de Delitos en Moche (year 2023)',
                 hole=0.5,
