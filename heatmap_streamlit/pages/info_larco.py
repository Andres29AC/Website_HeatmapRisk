...
st.set_page_config(page_title="Informacion Victor Larco Herrera",page_icon=":information_source:", layout="wide")

st.title(body=":chart_with_upwards_trend: Victor Larco Herrera")
...
data = {
    ...
    "Numero de Delitos (year 2023)": [314, 110, 58, 39, 11, 4, 1, 1]
}
...
fig_pie = px.pie(df_pie, values='Numero de Delitos (year 2023)', names='Categoria de Delito',
                 title='Distribucion de Delitos en Victor Larco Herrera (year 2023)',
                 hole=0.5,
