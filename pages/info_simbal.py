...
st.set_page_config(page_title="Informacion Simbal",page_icon=":information_source:", layout="wide")

st.title(body=":chart_with_upwards_trend: Simbal")
...
data = {
    ...
    "Numero de Delitos (year 2023)": [20, 16, 9, 1, 1, 1]
}
...
fig_pie = px.pie(df, values='Numero de Delitos (year 2023)', names='Categoria de Delito',
                 title='Distribucion de Delitos en Simbal (year 2023)',
                 hole=0.5,
